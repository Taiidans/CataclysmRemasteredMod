...
function Rule_Init() -- {{{
	...
	Player_SetPlayerName(1,"Taiidan Republic")
	Player_SetPlayerName(2,"Bentusi Exchange")
	Player_SetPlayerName(3,"The Beast")
        Player_SetPlayerName(4,"Taiidan Imperialist Faction")
		
	-- set the alliances for all of the taiidan republic ships
	SetAlliance( 0, 1 )
	SetAlliance( 1, 0 )
	SetAlliance( 0, 2 )
	SetAlliance( 2, 0 )
	...
	SetAlliance( 2, 1 )
        ...
        -- set the alliances for all of the beast/taiidan ships
        SetAlliance( 3, 4)
	SetAlliance( 4, 3 )
	...
	nbl_int_buffer = SobGroup_Count(Player_GetShipsByType(1, "Tai_interceptor"))
	nbl_mg_buffer = SobGroup_Count(Player_GetShipsByType(1, "Tai_multiguncorvette"))
	nbl_ion_buffer = SobGroup_Count(Player_GetShipsByType(1, "Tai_ioncannonfrigate"))	
	tai_int_buffer = SobGroup_Count(Player_GetShipsByType(3, "Bst_fighter"))
	tai_ion_buffer = SobGroup_Count(Player_GetShipsByType(3, "Bst_ioncannonfrigate"))
        nbl_int_buffer = SobGroup_Count(Player_GetShipsByType(4, "Tai_interceptor"))
	nbl_mg_buffer = SobGroup_Count(Player_GetShipsByType(4, "Tai_multiguncorvette"))
	nbl_ion_buffer = SobGroup_Count(Player_GetShipsByType(4, "Tai_ioncannonfrigate"))
...
--	print("hw2 Fleet command: "..HW2_FleetCommand)
	playEvent()
...
-- {{{ Rules to keep Taiidan  / Beast main battle going

function Rule_ReplaceNblInt() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (1, "Tai_interceptor")) < nbl_int_buffer ) then
		Rule_Remove("Rule_ReplaceNblInt")
		nbl_int_tmp = SobGroup_CreateShip(Player_GetShipsByType (1, "Tai_carrier"), "Tai_interceptor") 
...
function Rule_ReplaceNblMg() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (1, "Tai_multiguncorvette")) < nbl_mg_buffer ) then
		Rule_Remove("Rule_ReplaceNblMg")
		nbl_mg_int = SobGroup_CreateShip(Player_GetShipsByType (1, "Tai_carrier"), "Tai_multiguncorvette") 
...
function Rule_ReplaceNblIon() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (1, "Tai_ioncannonfrigate")) < nbl_ion_buffer ) then
		Rule_Remove("Rule_ReplaceNblIon")
		nbl_ion_tmp = SobGroup_CreateShip(Player_GetShipsByType (1, "Tai_carrier"), "Tai_ioncannonfrigate") 
...
function Rule_ReplaceTaiInt() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (3, "Bst_fighter")) < tai_int_buffer ) then
		Rule_Remove("Rule_ReplaceTaiInt")
		tai_int_tmp = SobGroup_CreateShip(Player_GetShipsByType (3, "Bst_carrier"), "Bst_fighter") 
...
function Rule_ReplaceTaiIon() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (3, "Bst_ioncannonfrigate")) < tai_ion_buffer ) then
		Rule_Remove("Rule_ReplaceTaiIon")
		tai_ion_tmp = SobGroup_CreateShip(Player_GetShipsByType (3, "Bst_carrier"), "Bst_ioncannonfrigate") 
...
function Rule_ReplaceNblInt() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (4, "Tai_interceptor")) < nbl_int_buffer ) then
		Rule_Remove("Rule_ReplaceNblInt")
		nbl_int_tmp = SobGroup_CreateShip(Player_GetShipsByType (4, "Tai_carrier"), "Tai_interceptor") 
		Rule_Add("Rule_checkbuilt_NblInt")
	end
end -- }}}
function Rule_checkbuilt_NblInt() -- {{{
...
function Rule_ReplaceNblMg() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (4, "Tai_multiguncorvette")) < nbl_mg_buffer ) then
		Rule_Remove("Rule_ReplaceNblMg")
		nbl_mg_int = SobGroup_CreateShip(Player_GetShipsByType (4, "Tai_carrier"), "Tai_multiguncorvette") 
		Rule_Add("Rule_checkbuilt_NblMg")
	end
end -- }}}
function Rule_checkbuilt_NblMg() -- {{{
...
function Rule_ReplaceNblIon() -- {{{
	if( SobGroup_Count(Player_GetShipsByType (4, "Tai_ioncannonfrigate")) < nbl_ion_buffer ) then
		Rule_Remove("Rule_ReplaceNblIon")
		nbl_ion_tmp = SobGroup_CreateShip(Player_GetShipsByType (4, "Tai_carrier"), "Tai_ioncannonfrigate") 
		Rule_Add("Rule_checkbuilt_NblIon")
	end
end -- }}}
function Rule_checkbuilt_NblIon() -- {{{
